...
const skillCategories = [
  {
    title: "Développement",
    skills: ["Java 21", "Python", "C", "JavaScript", "TypeScript", "PHP", "Dart", "Shell", "PL/SQL"],
  },
  {
    title: "Frameworks",
    skills: ["Quarkus", "Spring Boot", "Angular", "React.js", "React Native"],
  },
  {
  ...
  {
    title: "DevOps & Cloud",
    skills: ["Docker", "Jenkins", "Kubernetes", "Ansible", "CI/CD", "SonarQube"],
  },
  {
    title: "Outils & Méthodes",
    skills: ["GitLab/GitHub", "Jira", "Postman", "Bruno", "JUnit 5", "IntelliJ", "Agile SAFe"],
  },
];
