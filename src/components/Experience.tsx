...
const experiences = [
  {
    type: "work",
    title: "Stagiaire Ingénieur (PFE)",
    company: "Orange Business Maroc",
    period: "Mars 2026 – Août 2026",
    description: "Développement d'un microservice \"Panier\" pour la gestion du parc mobile des clients ME en Agile SAFe (Java, Quarkus, MySQL, JUnit 5, CI/CD, SonarQube, Bruno, GitLab/GitHub).",
  },
  {
    type: "work",
