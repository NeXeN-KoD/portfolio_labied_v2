...
const projects = [
  ...
  {
    title: "Hackathon Innovation CIH Bank x UIR",
    description: "Prototypage Figma, réalisation d'une application mobile et d'une plateforme desktop pour les pharmacies afin d'aider les pauvres obtenir des médicaments.",
    tech: ["Figma", "React Native", "Firebase", "Desktop"],
    featured: true,
    image: HackathonImg,
  },
  {
  ...
  {
    title: "Vote électronique Blockchain Privée",
  ...
  {
    title: "MLOps : Prédiction Météorologique",
    ...
    tech: ["Azure Web Apps", "Docker", "Power BI", "Microsoft Entra ID"],
    featured: false,
    image: CloudImg,
  }
];
        ...
        <div className="container max-w-6xl mx-auto relative">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Une sélection de projets techniques illustrant mon expertise Fullstack, DevOps et mon esprit d'innovation.
            </p>
          </motion.div>
